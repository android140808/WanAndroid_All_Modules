...
import com.avatar.wan.common.ext.handleRequest
import com.avatar.wan.common.ext.launch
import com.avatar.wan.module_home.data.DataRepository
...
class HomeViewModel : BaseViewModel() {
    ...
    fun fetchBanners() {
        launch({
            handleRequest(
                response = DataRepository.getBanner(),
                successBlock = {
